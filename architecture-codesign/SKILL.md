...
- **Repo / CI / testing:** `implementation_plan.md` (see structure below), `repo-structure.md`, `testing-philosophy.md` (test types, coverage targets, what to skip and why), `ci-pipeline.md`, `CONTRIBUTING.md`, ADR template, PR template, branch protection notes.
